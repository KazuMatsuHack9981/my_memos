...
case $1 in
	...
	docker    ) cat ~/desktop/memos/docker_about.md ~/desktop/memos/docker_commands.md | awk "/$2/,/\*\*\*/" | sed -r "s/($2)/\x1b[38;5;82m\1\x1b[0m/g";;
	gedit     ) cat ~/desktop/memos/gedit_settings_memo.md | awk "/$2/,/\*\*\*/" | sed -r "s/($2)/\x1b[38;5;82m\1\x1b[0m/g";;
